...
void imprimirMenu(){
    ...
    printf("Digite 1: Inicializar sua agenda. \n");
    printf("Digite 2: Adicione um contato. \n");
    printf("Digite 3: Imprimir lista de contatos. \n");
    printf("Digite 4: Apagar contato por identificador. \n");
    printf("Digite 5: Apagar contato por nome. \n");
    printf("Digite 6: Apagar contato por identificador. \n");
    printf("Digite 7: Editar contato por nome. \n");
...
void imprimirContatosId(contato contatos){
...
void editarContatoId(contato listaContatos[], int qtdContatos, int idContatoEditar){
    ...
    for(int i = 0; i < qtdContatos; i++){
        ...
        if(listaContatos[i].id == idContatoEditar && listaContatos[i].id != -1){
            ...
            imprimirContatosId(listaContatos[i]);
...
void editarContatoNome(contato listaContatos[], int qtdContatos, char *nomeContatoEditar){

    int editou = 0;

    for(int i = 0; i < qtdContatos; i++){

        if(strcmp(listaContatos[i].nome, nomeContatoEditar) == 0){
...
void inicializarAgenda(contato listaContatos[], int qtdContatos){
    for(int i = 0; i < qtdContatos; i++){
        listaContatos[i].id = -1;
    }
    printf("Lista de contato inicializada com sucesso! \n");
}

void imprimirListaContatos(contato listaContatos[], int qtdContatos){
    ...
    if(imprimiu == 1) printf("Lista de contatos impressa com sucesso! \n");
    else printf("Lista de contatos vazia! Adicione um contato. \n");
}
...
void apagarContatoNome(contato listaContatos[], int qtdContatos, char *nomeApagar){
    int apagou = 0; 

    for(int i = 0; i < qtdContatos; i++){
        int iguais = strcmp(listaContatos[i].nome, nomeApagar);
            if(iguais == 0){
                listaContatos[i].id = -1;
                apagou = 1;
        }
